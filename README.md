# Identify Customer Segments Using Unsupervised Learning Algorithms
...
1. Use unsupervised learning techniques to organize the general population into clusters
2. Use those clusters to see which of them comprise the main user base for the company. 
3. Prior to applying the machine learning methods, you will also need to assess and clean the data in order to convert the data into a usable form.
